...
export default function StatsCard({ icon: Icon, label, value, trend, accent = 'emerald', href }: StatsCardProps) {
  ...
  const className = 'bg-white rounded-xl border border-slate-200 p-5 card-hover hover:border-slate-300 block';
